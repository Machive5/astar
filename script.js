...
document.querySelector('.howToUse').getElementsByTagName("button")[0].addEventListener('click',()=>{
    document.querySelector('.howToUse').style.display = 'none';
});
...
function astarAlgorithm()
{
    ...
    function direction(pi,pj,i,j){ // looking the all the 8 direction of each node
        let f,g,h
